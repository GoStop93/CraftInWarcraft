...
import { StyledContainer, StyledLayerBack, StyledImg, StyledFristPartTitle, StyledSecondPartTitle } from './ExplorerLink.styles';
import { RainEffect } from '../../../components/RainEffect/RainEffect';

export const ExplorerLink = React.memo(() => {
    ...
    <StyledContainer>
      <StyledLayerBack>
        <Link style={{ textDecoration: 'none' }} to={`/explorer`}>
          <StyledImg src={Sylvana} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} />
        </Link>
        <CSSTransition in={rainFalling} timeout={duration} classNames="image" mountOnEnter unmountOnExit>
          <div>
