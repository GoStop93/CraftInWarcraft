...
import { StyledContainer, StyledBox, StyledLogo, StyledFullImage, StyledPartImage, StyledBoxForImage, StyledRaceName } from './RaceCard.styles';

export const RaceCard = ({ color, smallLogo, name, iconFull, iconPart, text }: IRaceCardProps) => {
  return (
    <StyledContainer>
