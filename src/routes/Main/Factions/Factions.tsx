...
export const Factions = React.memo(() => {
    ...
    <StyledContainer>
      <StyledInformation>
        <StyledHeader>
          ...
          <StyledSubtitle>
            Be the hero you want to be. Will you fight as a hulking Tauren Warrior? Or perhaps an inventive Gnome Warlock? The choice is yours—but
        ...
        <StyledContentHorde>
          <StyledFaction>
            ...
            <StyledFactionDescription>
              The Horde fights for honor and freedom, surviving in a world that questions their unity and strength.
            </StyledFactionDescription>
            <CSSTransition in={showHorde} timeout={duration} classNames="image" mountOnEnter unmountOnExit>
          ...
          <StyledFaction>
            ...
            <CSSTransition in={showAlliance} timeout={duration} classNames="image" mountOnEnter unmountOnExit>
