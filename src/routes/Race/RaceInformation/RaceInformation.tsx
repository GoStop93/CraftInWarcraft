...
export const RaceInformation = React.memo(({ color, raceAdditionalInformation }: IRaceInfirmatioProps) => {
      ...
      {raceAdditionalInformation.map((block, index) => (
        <React.Fragment key={index}>
          ...
          {openModalIndex === index && (
            <ModalWindow big hasBackground onCloseHandler={handleCloseModal}>
