...
export const availableClasses: Class[] = [
  ...
  },
  {
    className: 'druid',
    description:
      'Druids harness the vast powers of nature to preserve balance and protect life. As master shapeshifters, druids can take on the forms of a variety of beasts, each focused on a specific combate role',
    icon: DruidIcon,
  },
  {
