  ...
  return !classInfo ? null : (
    <>
      ...
      <StyledContainer background={classInfo.backgroundImage}>
        ...
        <StyledContent>
          <StyledClassImage src={classInfo.classImage} alt={formattedClassName} width={classInfo.width} left={classInfo.left} top={classInfo.top} />
          <StyledInfo>
          ...
          <StyledSpecializationContainer>
            ...
            <StyledSpecializationCards>
              {classInfo.specializations.map((specialization) => (
                <SpecializationCard key={specialization.name} name={specialization.name} text={specialization.text} icon={specialization.icon} />
              ))}
            </StyledSpecializationCards>
          </StyledSpecializationContainer>
        </StyledContent>
