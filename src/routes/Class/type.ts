...
export const classInformation: ClassInformation = {
    ...
    shaman: {
        ...
        classDescription: 'During combat, shaman place damaging and controlling totems on the ground to maximize their effectiveness while hindering their enemies. Shaman are versatile enough to battle foes up close or at range, but wise shaman choose their avenue of attack based on their enemies’ strengths and weaknesses.',
        textColor: '#2F5884',
        width: 100,
        left: 43,
        top: 17,
    ...
    monk: {
        ...
        classDescription: 'Whatever their combat role, monks rely mainly on their hands and feet to do the talking, and on strong connection with their inner chi to power their abilities. Monks can also heal their allies while at the same time damaging their enemies.',
        textColor: '#AF8130',
        width: 120,
        left: 50,
        top: 5,
    ...
    druid: {
        ...
        classDescription: 'Druids are versatile combatants, in that they can fulfill nearly every role – healing, tanking, and damage dealing. It’s critical that druids tailor the form they choose to the situation, as each form bears a specific purpose',
        textColor: '#8CA0C9',
        width: 70,
        left: 50,
        top: 17,
    ...
    demon_hunter: {
        ...
        classDescription: 'Forgoing heavy armor, Demon Hunters capitalize on speed, closing the distance quickly to strike enemies with one-handed weapons. However, Illidari must also use their agility defensively to ensure that battles end favorably.',
        textColor: '#71F021',
        width: 100,
        left: 50,
        top: 17,
