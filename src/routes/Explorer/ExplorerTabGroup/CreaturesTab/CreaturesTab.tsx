...
export const CreaturesTab = ({ offset }: ITabProps) => {
  ...
  return (
    <StyledContainer>
      ...
      <StyledBottomContent>
        <StyledRandomContent>
          <CSSTransition in={rainFalling} timeout={duration} classNames="text" mountOnEnter unmountOnExit>
            <StyledRandomText>Show me another creature!</StyledRandomText>
          </CSSTransition>
          <StyledDemon src={Demon} onClick={fetchRandomCreature} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} />
        </StyledRandomContent>
        <StyledCreatureInformationContainer>
          <StyledCreatureInformation>
            {loading ? (
              ...
              <>
                <StyledCreatureImage src={creatureImage} />
                <StyledCreatureContent>
          ...
          <StyledCreatureSearch>
            <StyledButtonAndInputTitle>
              ...
              >
                <StyledForm>
                  <MyTextInput id="name" name="name" type="text" />
