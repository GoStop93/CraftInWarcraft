      ...
      <StyledContainer>
                ...
                <StyledVideo>
                  {currentSlide.url ? (
                    ...
                    <>
                      ...
                      <StyledBackCardText>
                        We're going to use this extra bandwidth to run an ajax request and force the CDN to put the page you're looking for right
                        above the fold... aaaaand it's gone. Your page is gone. Poof. It's all gone.
                      </StyledBackCardText>
                    </>
                  )}
                </StyledVideo>
        ...
        {modalIsOpen ? (
          <ModalWindow medium hasBackground onCloseHandler={closeModal}>
            <ReactPlayer url={currentSlide.url} width="718px" height="404px" controls />
          </ModalWindow>
        ) : null}
      </StyledContainer>
    </ReactLenis>
